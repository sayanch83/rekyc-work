...
const SEED = {
  customers: {
    ...
    'KYC-2290': {
      ...
      docsOnFile: [
        { name: 'PAN Card', meta: 'Verified – Lifetime', valid: true },
        { name: 'Aadhaar Card', meta: 'Last verified: 20 Jan 2024', valid: true },
      ],
    ...
    'KYC-8834': {
      ...
      docsOnFile: [
        { name: 'PAN Card', meta: 'Verified – Lifetime', valid: true },
        { name: 'Aadhaar Card', meta: 'Last verified: 14 Aug 2022', valid: true },
      ],
    ...
    'KYC-1190': {
      ...
      docsOnFile: [
        { name: 'PAN Card', meta: 'Verified – Lifetime', valid: true },
        { name: 'Voter ID', meta: 'No. TN/XXXXX', valid: true },
        { name: 'Aadhaar Card', meta: 'Last verified: 08 Nov 2023', valid: true },
      ],
    ...
    'KYC-9901': {
      ...
      docsOnFile: [
        { name: 'PAN Card', meta: 'Verified – Lifetime', valid: true },
        { name: 'Passport', meta: 'No. M87654XX – Exp: 22 Sep 2024', valid: false },
      ],
    ...
    'KYC-4421': {
      ...
      docsOnFile: [
        { name: 'PAN Card', meta: 'Verified – Lifetime', valid: true },
        { name: 'Passport', meta: 'No. P23456XX – Exp: 30 Jun 2029', valid: true },
        { name: 'Aadhaar Card', meta: 'Last verified: 03 Dec 2023', valid: true },
      ],
    ...
    'KYC-7723': {
      ...
      docsOnFile: [
        { name: 'PAN Card', meta: 'Verified – Lifetime', valid: true },
        { name: 'Aadhaar Card', meta: 'Last verified: 19 Jul 2023', valid: true },
      ],
